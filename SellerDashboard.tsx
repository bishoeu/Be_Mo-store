...
import { ChevronLeft, Plus, TrendingUp, Package, DollarSign } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container py-12">
        ...
        <div className="mb-12">
          ...
          <p className="text-foreground/70">{seller.storeDescription}</p>
          <div className="mt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          <div className="bg-card border border-border rounded-lg p-6">
            <div className="flex items-center justify-between mb-2">
              <span className="text-foreground/70 text-sm font-medium">Total Products</span>
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            <div className="flex items-center justify-between mb-2">
              <span className="text-foreground/70 text-sm font-medium">Total Sales</span>
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            <div className="flex items-center justify-between mb-2">
              <span className="text-foreground/70 text-sm font-medium">Total Revenue</span>
              <DollarSign className="w-5 h-5 text-green-600" />
            </div>
            <p className="text-3xl font-bold text-foreground">EGP {Math.round(parseFloat(seller.totalRevenue.toString()))}</p>
            <p className="text-xs text-foreground/60 mt-2">Gross sales</p>
          </div>

          <div className="bg-card border border-border rounded-lg p-6">
            <div className="flex items-center justify-between mb-2">
              <span className="text-foreground/70 text-sm font-medium">Available Balance</span>
              <DollarSign className="w-5 h-5 text-primary" />
            </div>
            <p className="text-3xl font-bold text-foreground">EGP {Math.round(parseFloat(seller.currentBalance.toString()))}</p>
            ...
            <div className="bg-card border border-border rounded-lg p-6 mb-6">
              ...
              <form onSubmit={handleCreateProduct} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-foreground mb-2">Price (EGP) *</label>
                    <input
                      type="number"
                      value={productPrice}
